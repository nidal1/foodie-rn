        ...
        <View className="justify-between flex-1 w-full px-6">
          <View className="z-20 justify-center items-center">
            <View className="flex-row gap-2">
              <Text className="font-montserrat font-semibold text-[34px] text-[#222B45] mb-5 leading-[41px]">
                Gluten
              </Text>
              <Text className="font-montserrat font-semibold text-[34px] text-[#222B45] mb-5 leading-[41px] border-b-2 border-[#DB9F01]">
                Free
              </Text>
            </View>

            <Text className="font-montserrat font-semibold text-base text-secondary-2 text-center">
          ...
          <View className="gap-[20px]">
            ...
            >
              <View className="flex-row gap-2 items-center">
                ...
                <Text className="font-montserrat font-semibold text-base text-secondary-1">
                  Login with Facebook
                </Text>
              </View>
            </Button>
